...
public class Condutor extends Pessoa{
	...
	protected Condutor(String nome, String cpf, String email, String senha, String dataNasc, int idCondutor,
			String eventoConduzido) {
		super(nome, cpf, email, senha, dataNasc);
		this.idCondutor = idCondutor;
		this.eventoConduzido = eventoConduzido;
	}

	private int getIdCondutor() {
		return idCondutor;
	}

	private String getEventoConduzido() {
